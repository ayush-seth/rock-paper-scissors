...
export default function Home() {
  return (
    <div>
      ...
      <div className="text-[hsl(229,25%,31%)] bg-white p-10 rounded-lg w-fit">
        <div className="flex justify-between items-center mb-12">
          <span className="uppercase font-bold text-4xl">Rules</span>
          <button>
      ...
      <button className="absolute bottom-10 right-10 uppercase text-white border py-2 px-10 tracking-widest rounded-lg">
        Rules
      </button>
    </div>
  );
